...
Configure o número do WhatsApp no arquivo `app/cart/page.tsx` (linha ~70):
...
As imagens estão configuradas para aceitar URLs do Unsplash. Para adicionar outros domínios, edite `next.config.ts`.

## 📝 Notas

- Este projeto é a versão web do app React Native
- Mantém o mesmo design e funcionalidades
- Otimizado para desktop e mobile
- SEO-friendly com Next.js
